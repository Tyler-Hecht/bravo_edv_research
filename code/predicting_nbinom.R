...
# THIS FILE IS THE SAME AS predicting.R BUT WITH NBINOM
...
PLOT.OUTPUT.FILE <- paste(paste("../plots/predictions/predictions", COVARIATE, START.DATE, END.DATE, SPLIT, FORMULA.NUM, "nbinom2", sep = "_"), ".png", sep="")
MODEL.OUTPUT.FILE <- paste("../data/", COVARIATE, "/", paste(COVARIATE, START.DATE, END.DATE, SPLIT, FORMULA.NUM, "nbinom2", sep = "_"), ".RData", sep="")
PLOT.DATA.FOLDER <- paste("../data/", COVARIATE, "/", paste(COVARIATE, START.DATE, END.DATE, SPLIT, FORMULA.NUM, "nbinom2", sep="_"), sep = "")
